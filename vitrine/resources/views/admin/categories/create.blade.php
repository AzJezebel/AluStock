...
@section('title', 'Ajouter une catégorie - AluStock Admin')
@section('page-title', 'Ajouter une catégorie')
@section('page-subtitle', 'Créer une nouvelle catégorie pour organiser vos ouvrages')
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <div class="flex gap-2">
                        <input type="text" id="icone" name="icone" value="{{ old('icone', 'fa-tag') }}"
                               placeholder="fa-tag"
                        ...
                        <div class="px-4 py-2 bg-gray-50 border border-gray-300 rounded-lg flex items-center">
                            <i class="fas {{ old('icone', 'fa-tag') }} text-amber-500" id="icone_preview"></i>
                        </div>
                    </div>
