...
<div>
    ...
    {{-- ============================================================ --}}
    {{-- CARROUSEL D'IMAGES (grand, centré) --}}
    {{-- ============================================================ --}}
    @if($ouvrage->medias->count() > 0)
        <div class="mb-6">
            @include('public.partials.media-carousel', [
                ...
                'large' => true, // Nouvelle option pour agrandir
            ])
        </div>
    @endif
    ...
    <div class="bg-white rounded-xl shadow-sm border border-ink-200 p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-3">
            <a href="{{ route('ouvrages.composition', $ouvrage->slug) }}" 
               class="flex items-center justify-center w-full px-4 py-2 bg-amber-50 text-amber-700 rounded-lg hover:bg-amber-100 transition text-sm font-medium">
            ...
            <a href="{{ route('ouvrages.print', $ouvrage->slug) }}" target="_blank"
               class="flex items-center justify-center w-full px-4 py-2 bg-ink-100 text-ink-700 rounded-lg hover:bg-ink-200 transition text-sm font-medium">
                <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <a href="#" 
               class="flex items-center justify-center w-full px-4 py-2 bg-amber-700 text-white rounded-lg hover:bg-amber-800 transition text-sm font-medium">
                <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
